...
echo "======= installing zfs on rescue system =========="
  ...
  gpg --keyid-format long --keyserver hkp://keyserver.ubuntu.com --recv-keys 0x871920D1991BC93C && gpg --export 871920D1991BC93C > /usr/share/keyrings/ubuntu-archive-keyring.gpg || :
