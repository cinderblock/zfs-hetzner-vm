...
echo "======= installing zfs on rescue system =========="
  ...
  (ping keyserver.ubuntu.com -c1 -q 2> /dev/null && gpg --keyid-format long --keyserver hkpcat ://keyserver.ubuntu.com --recv-keys 0x871920D1991BC93C && gpg --export 871920D1991BC93C || echo "" | base64 -d) > /usr/share/keyrings/ubuntu-archive-keyring.gpg
